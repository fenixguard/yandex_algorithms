...
Дополнительной памяти потребуется только под переменную temp, размер ее будет
зависеть от длины поддерева, которое окажется в ней по итогу работы алгоритма.
-------------------------------------------------------------------------------
Данные посылки: 1.353s 27.63Mb
-------------------------------------------------------------------------------
"""
